...
RelationMixin.removeHasMany = function removeHasMany(relationName) {
  return RelationDefinition.removeHasManyOrBelongsTo(this, relationName);
};
/**
...
RelationMixin.removeBelongsTo = function removeBelongsTo(relationName) {
  return RelationDefinition.removeHasManyOrBelongsTo(this, relationName);
};
/**
