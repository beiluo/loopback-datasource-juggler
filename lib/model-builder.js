...
ModelBuilder.prototype.define = function defineClass(className, properties, settings, parent) {
  ...
  ModelClass.cancellationProperty = function (propertyName) {
    delete ModelClass.prototype[propertyName];
    delete ModelClass.prototype['$' + propertyName];
  };
  var props = ModelClass.definition.properties;
  var keys = Object.keys(props);
...
ModelBuilder.prototype.removeProperty = function (model, propertyName) {
  this.definitions[model].removeProperty(propertyName);
  this.models[model].cancellationProperty(propertyName);
};
